...
namespace TimeProviderHeader
{
  ...
  inline constexpr char const* NAME_GET_MICROSECONDS_TIME{ "_GetMicrosecondsTime@0" };
  ...
  inline FuncGetMicrosecondsTime GetMicrosecondsTime{ nullptr };
  ...
  inline bool initModuleFunctions()
  {
    ...
    GetMicrosecondsTime = (FuncGetMicrosecondsTime) ucp_getProcAddressFromLibraryInModule(NAME_MODULE, NAME_LIBRARY, NAME_GET_MICROSECONDS_TIME);
    ...
    return GetFullNanosecondsTime && GetNanosecondsTime && GetMicrosecondsTime && GetMillisecondsTime;
  }
}
